...
export default function SignInUser( {setComp} :myComponentProps){
    ...
    return <>
        <div className="border p-4 rounded-2xl  flex flex-col w-full px-20">
            <div className="flex justify-center text-4xl font-bold m-2 mb-4">Sign In</div>
            <input onChange={(e)=>{
            ...
            <div className="flex justify-center">Don't have an account ? <span className="mx-2 cursor-pointer underline" onClick={()=>{
                setComp('SignUpUser')
